...
or_plot1 <- plot_title_freq + 
  geom_shadowtext(data = freq_top5, aes(label = names, x = x, y = y), inherit.aes = FALSE, size = 2, bg.colour='violetred4') 

or_plot1_cities <- or_plot1 + geom_point(aes(x = long, y = lat), data = cities, inherit.aes = FALSE, color = "red") + geom_text_repel(aes(x = long, y = lat, label = city), data = cities, inherit.aes = FALSE, color = "red", size = 2, fontface = "bold")
```
...
or_plot2_cities <- or_plot2 + geom_point(aes(x = long, y = lat), data = cities, inherit.aes = FALSE, color = "red") + geom_text_repel(aes(x = long, y = lat, label = city), data = cities, inherit.aes = FALSE, color = "red", size = 2, fontface = "bold")
